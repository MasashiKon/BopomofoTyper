...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, readBody, getQuery as getQuery$1, createError, getResponseStatusText } from 'file:///Users/masashi/Codes/BopomofoTyper/node_modules/h3/dist/index.mjs';
import axios from 'file:///Users/masashi/Codes/BopomofoTyper/node_modules/axios/index.js';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/masashi/Codes/BopomofoTyper/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/masashi/Codes/BopomofoTyper/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/masashi/Codes/BopomofoTyper/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///Users/masashi/Codes/BopomofoTyper/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/masashi/Codes/BopomofoTyper/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/masashi/Codes/BopomofoTyper/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/masashi/Codes/BopomofoTyper/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/masashi/Codes/BopomofoTyper/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/masashi/Codes/BopomofoTyper/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Users/masashi/Codes/BopomofoTyper/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/masashi/Codes/BopomofoTyper/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/masashi/Codes/BopomofoTyper/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/masashi/Codes/BopomofoTyper/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/masashi/Codes/BopomofoTyper/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/masashi/Codes/BopomofoTyper/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file:///Users/masashi/Codes/BopomofoTyper/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/masashi/Codes/BopomofoTyper/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/masashi/Codes/BopomofoTyper/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/masashi/Codes/BopomofoTyper/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/masashi/Codes/BopomofoTyper","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/masashi/Codes/BopomofoTyper/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/masashi/Codes/BopomofoTyper/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/masashi/Codes/BopomofoTyper/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/masashi/Codes/BopomofoTyper/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _HEzoMV1nXz = (function(nitro) {
...
const _lazy_FeYWrO = () => Promise.resolve().then(function () { return sentenses_post$1; });
const _lazy_1dsID5 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/sentenses', handler: _lazy_FeYWrO, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_1dsID5, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_1dsID5, lazy: true, middleware: false, method: undefined }
];
...
const generateQuery = (level, innerLevel) => {
  return `{
...
const sentenses_post = defineEventHandler(async (event) => {
...
const sentenses_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: sentenses_post
});
...
const getClientManifest = () => import('file:///Users/masashi/Codes/BopomofoTyper/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/masashi/Codes/BopomofoTyper/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
